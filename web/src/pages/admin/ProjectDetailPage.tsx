  ...
  return (
    <div className="mt-3 border-t border-gray-100 pt-3">
      {data.missingStandardRoles.length > 0 && (
        <p className="text-xs text-amber-700">Missing: {data.missingStandardRoles.join(', ')}</p>
      )}
      ...
      <form onSubmit={handleSubmit} className="mt-3 grid max-w-md grid-cols-2 gap-2">
        ...
        <button
          type="submit"
          className="col-span-2 rounded-md border border-gray-300 px-2 py-1.5 text-sm text-gray-700 hover:bg-gray-50"
        >
